...
public class IndustrialCraftOreGeneration {
	...
	public final int MARBLE_ID = 142;
	public final byte DEFAULT_METADATA = 0;
	public final int REDPOWER_ORE_ID = 140;
	public final byte RUBY_ORE_METADATA = 0;
	public final byte EMERALD_ORE_METADATA = 1;
	public final byte SAPPHIRE_ORE_METADATA = 2;
	public final byte SILVER_ORE_METADATA = 3;
	public final byte TUNGSTEN_ORE_METADATA = 6;
	public final byte NIKOLITE_ORE_METADATA = 7;
